...
- (void)displayReportComposer:(BOOL)attachImage{
    if (![self canSendNewReport]) {
        [self showMessage:@"Apple Mail is not setup on this device. Please setup the Apple Mail app or email suppor@viewglass.com to give feedback." withTitle:@"Error"];
        return;
    }
